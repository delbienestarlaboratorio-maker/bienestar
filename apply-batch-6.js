...
const batchDataFile = path.join(__dirname, 'batch6.json');
...
try {
    ...
    console.log(`✅ LOTE 6 COMPLETO: Se actualizaron con éxito ${updated} biomarcadores locales.`);
} catch (e) {
    console.error("Error al ejecutar el lote 6: ", e);
}
