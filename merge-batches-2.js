...
const batchFiles = ['symptoms-batch-4.json', 'symptoms-batch-5.json', 'symptoms-batch-6.json'];
let added = 0;
...
console.log(`✅ Base de datos actualizada: ${db.length} padecimientos totales (Se agregaron ${added} nuevos de los lotes 4, 5 y 6).`);
