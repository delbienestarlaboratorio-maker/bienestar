...
const batchFiles = ['symptoms-batch-13.json', 'symptoms-batch-14.json', 'symptoms-batch-15.json'];
let added = 0;
...
console.log(`✅ Base de datos actualizada: ${db.length} padecimientos enciclopédicos totales (Se agregaron ${added} nuevos de los bloques 13, 14 y 15).`);
