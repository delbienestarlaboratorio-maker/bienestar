...
export const metadata: Metadata = {
  ...
  title: {
    default: "Herramientas de Salud Gratuitas | Calculadoras Médicas | Laboratorio Bienestar",
    template: "%s | Laboratorio Bienestar",
  },
  description: "Más de 130 calculadoras médicas gratuitas: IMC, Glasgow, riesgo cardiovascular, diabetes, embarazo y más. Herramientas validadas científicamente.",
  keywords: ["calculadora médica", "herramienta salud", "calculadora IMC", "riesgo diabetes", "escala Glasgow", "calculadora embarazo"],
  authors: [{ name: "Laboratorio Bienestar" }],
  openGraph: {
    title: "Herramientas de Salud Gratuitas | Laboratorio Bienestar",
    description: "Más de 130 calculadoras médicas gratuitas y validadas científicamente.",
    url: BASE_URL,
    siteName: "Laboratorio Bienestar - Herramientas",
    locale: "es_MX",
    type: "website",
  },
  robots: {
  ...
  alternates: {
    canonical: 'https://herramientas.delbienestar.com.mx',
  },
};
...
y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`} suppressHydrationWarning>
        {/* Simple header linking back to main site */}
          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <a href={LAB_URL} className="flex items-center gap-2 text-white hover:text-green-200 transition-colors">
              ...
              <div>
                ...
                <span className="text-green-300 text-sm block">Herramientas de Salud</span>
              </div>
            </a>
            <nav className="hidden md:flex items-center gap-6 text-sm">
              <a href="/herramientas/" className="text-green-200 hover:text-white transition-colors">🧮 Todas las Herramientas</a>
              <a href={`${LAB_URL}/estudios/analisis-clinicos`} className="text-green-200 hover:text-white transition-colors">🔬 Estudios</a>
              <a href={`${LAB_URL}/check-ups`} className="text-green-200 hover:text-white transition-colors">📋 Check-Ups</a>
        ...
        <footer className="bg-gray-900 text-gray-400 py-12 px-4">
          <div className="max-w-6xl mx-auto text-center">
            <p className="text-sm">© {new Date().getFullYear()} Laboratorio Clínico Del Bienestar. Todas las herramientas son gratuitas y de uso informativo.</p>
            <p className="text-xs mt-2">Los resultados no sustituyen el diagnóstico médico profesional.</p>
        ...
        <a
          ...
          className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-400 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg z-50 transition-all hover:scale-110"
