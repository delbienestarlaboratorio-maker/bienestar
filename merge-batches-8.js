...
const batchFiles = [
    'symptoms-batch-21.json',
    'symptoms-batch-22.json'
];

function mergeBatches() {
    console.log("=== INICIANDO INTEGRACIÓN DE LOTES 21 Y 22 ===");
    let masterData = [];
    ...
    // 3. Escribir el nuevo archivo maestro si hubo cambios
    if (addedCount > 0) {
        try {
        ...
        console.log("\n[INFO] No se encontraron nuevas enfermedades válidas para agregar en estos lotes.");
    }
}
