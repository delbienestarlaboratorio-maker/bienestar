...
const BANNERS: BannerItem[] = [
    {
        title: '🔬 Check-Up Básico desde $499',
        subtitle: 'Incluye Biometría Hemática, Glucosa, Perfil de Lípidos y más',
        cta: 'Ver Check-Ups',
        href: '/check-ups',
    ...
    {
        title: '💉 Sueroterapia Vitamínica',
        subtitle: 'Recupera energía, fortalece tu sistema inmune. 10 tratamientos IV disponibles',
        cta: 'Conocer Más',
        href: '/sueroterapia',
    ...
    },
    {
        ...
        subtitle: 'Atención personalizada • Resultados en 24-48 hrs • Sin filas',
        cta: 'Chatear Ahora',
        href: 'https://wa.me/527716854026?text=Hola,%20necesito%20información%20sobre%20estudios',
        gradient: 'from-emerald-600 via-teal-700 to-cyan-800',
        icon: '📲',
    },
    {
        title: '🎯 Hasta 30% de Descuento',
        subtitle: 'Promociones exclusivas en paquetes de estudios clínicos este mes',
        cta: 'Ver Promociones',
        href: '/promociones',
    ...
    {
        title: '🧬 +2,000 Estudios Disponibles',
        subtitle: 'Análisis clínicos, radiología, cardiología, ultrasonido y más',
