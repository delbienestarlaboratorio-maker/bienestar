...
export const metadata: Metadata = {
  title: 'Precio de Tamizaje Metabólico Neonatal Ampliado en Tizayuca | Laboratorio Del Bienestar',
  description: 'Tamizaje Metabólico Neonatal Ampliado en Tizayuca desde $1,200 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/antidepresivos-tamizaje-tizayuca' },
  openGraph: {
    title: 'Precio de Tamizaje Metabólico Neonatal Ampliado en Tizayuca | Laboratorio Del Bienestar',
    description: 'Tamizaje Metabólico Neonatal Ampliado en Tizayuca desde $1,200 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/antidepresivos-tamizaje-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Tamizaje Metabólico Neonatal Ampliado</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Tamizaje Metabólico Neonatal Ampliado<br />
            <span className="text-green-300">en Tizayuca, Hidalgo</span>
          </h1>

          <p className="text-green-100 text-lg max-w-2xl mb-8">
            Panel que detecta más de 30 enfermedades metabólicas congénitas: hipotiroidismo congénito, fenilcetonuria, galactosemia, hiperplasia suprarrenal congénita y hemoglobinopatías. El diagnóstico temprano permite tratamiento oportuno y previene daño irreversible.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur rounded-2xl px-8 py-5 text-center border border-white/20">
              ...
              <p className="text-5xl font-extrabold text-white">$1,200</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito Tamizaje Metabólico Neonatal Ampliado?</h2>
            <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Recién nacido entre 48-72 horas de vida</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Obligatorio en México por NOM-034-SSA2</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Detección temprana de enfermedades metabólicas</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Antecedentes familiares de enfermedades hereditarias</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Antes del alta hospitalaria</span>
                </li>
            </ul>
          </section>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">Muestra de sangre del talón del recién nacido entre 48-72 horas postparto. Impregnada en papel filtro especial (tarjeta de Guthrie). No requiere ayuno.</p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Tamizaje Metabólico Neonatal Ampliado en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Tamizaje Metabólico Neonatal Ampliado es de <strong>$1,200 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Tamizaje Metabólico Neonatal Ampliado?</h3>
          ...
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-bold text-lg leading-tight">Tamizaje Metabólico Neonatal Ampliado</p>
              </div>
            </div>
            ...
            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20Tamizaje%20Metab%C3%B3lico%20Neonatal%20Ampliado%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
