...
export const metadata: Metadata = {
  title: 'Precio de Rayos X de Columna Lumbosacra AP y Lateral en Tizayuca | Laboratorio Del Bienestar',
  description: 'Rayos X de Columna Lumbosacra AP y Lateral en Tizayuca desde $320 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/rayos-x-columna-tizayuca' },
  openGraph: {
    title: 'Precio de Rayos X de Columna Lumbosacra AP y Lateral en Tizayuca | Laboratorio Del Bienestar',
    description: 'Rayos X de Columna Lumbosacra AP y Lateral en Tizayuca desde $320 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/rayos-x-columna-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Rayos X de Columna Lumbosacra AP y Lateral</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Rayos X de Columna Lumbosacra AP y Lateral<br />
            <span className="text-green-300">en Tizayuca, Hidalgo</span>
          </h1>

          <p className="text-green-100 text-lg max-w-2xl mb-8">
            Estudio radiológico de la columna lumbar y sacra que evalúa alineación vertebral, espacio discal, cuerpos vertebrales, pedículos y articulaciones facetarias. Detecta fracturas, escoliosis y cambios degenerativos.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito Rayos X de Columna Lumbosacra AP y Lateral?</h2>
            <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Lumbalgia crónica o aguda</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Traumatismo de columna</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Sospecha de hernia discal</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                ...
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Post-cirugía de columna</span>
                </li>
            </ul>
          </section>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">Retirar objetos metálicos de la zona. Informar posibilidad de embarazo. Puede requerir posiciones específicas según indicación médica.</p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Rayos X de Columna Lumbosacra AP y Lateral en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Rayos X de Columna Lumbosacra AP y Lateral es de <strong>$320 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Rayos X de Columna Lumbosacra AP y Lateral?</h3>
        ...
        <aside className="space-y-5">
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-sm text-green-200">Radiología</p>
                <p className="font-bold text-lg leading-tight">Rayos X de Columna Lumbosacra AP y Lateral</p>
              </div>
            </div>
            ...
            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20Rayos%20X%20de%20Columna%20Lumbosacra%20AP%20y%20Lateral%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
