...
export const metadata: Metadata = {
  title: 'Precio de Índice Tobillo-Brazo (ITB / Doppler Arterial) en Tizayuca | Laboratorio Del Bienestar',
  description: 'Índice Tobillo-Brazo (ITB / Doppler Arterial) en Tizayuca desde $480 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/indice-tobillo-brazo-tizayuca' },
  openGraph: {
    title: 'Precio de Índice Tobillo-Brazo (ITB / Doppler Arterial) en Tizayuca | Laboratorio Del Bienestar',
    description: 'Índice Tobillo-Brazo (ITB / Doppler Arterial) en Tizayuca desde $480 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/indice-tobillo-brazo-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Índice Tobillo-Brazo (ITB / Doppler Arterial)</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Índice Tobillo-Brazo (ITB / Doppler Arterial)<br />
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">Reposo en decúbito de 10 minutos previos. Temperatura ambiente confortable. Retirar media-pantalón. El estudio es indoloro y dura 20-30 minutos.</p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Índice Tobillo-Brazo (ITB / Doppler Arterial) en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Índice Tobillo-Brazo (ITB / Doppler Arterial) es de <strong>$480 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Índice Tobillo-Brazo (ITB / Doppler Arterial)?</h3>
          ...
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-bold text-lg leading-tight">Índice Tobillo-Brazo (ITB / Doppler Arterial)</p>
              </div>
            </div>
            ...
            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20%C3%8Dndice%20Tobillo-Brazo%20(ITB%20%2F%20Doppler%20Arterial)%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
