...
export const metadata: Metadata = {
  title: 'Precio de Gasometría Arterial en Tizayuca | Laboratorio Del Bienestar',
  description: 'Gasometría Arterial en Tizayuca desde $450 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/gases-arteriales-tizayuca' },
  openGraph: {
    title: 'Precio de Gasometría Arterial en Tizayuca | Laboratorio Del Bienestar',
    description: 'Gasometría Arterial en Tizayuca desde $450 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/gases-arteriales-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Gasometría Arterial</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Gasometría Arterial<br />
            <span className="text-green-300">en Tizayuca, Hidalgo</span>
          </h1>

          <p className="text-green-100 text-lg max-w-2xl mb-8">
            Análisis de sangre arterial que mide pH, PaO2, PaCO2, HCO3 y saturación de O2. Permite clasificar trastornos ácido-base (acidosis/alcalosis respiratoria o metabólica) y evaluar la oxigenación pulmonar.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur rounded-2xl px-8 py-5 text-center border border-white/20">
              ...
              <p className="text-5xl font-extrabold text-white">$450</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito Gasometría Arterial?</h2>
            <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Insuficiencia respiratoria aguda</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>EPOC o asma grave</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Acidosis o alcalosis metabólica</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Monitoreo en UCI</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Oxigenoterapia o ventilación mecánica</span>
                </li>
            </ul>
          </section>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">Mantener reposo 20-30 minutos previos. No cambiar parámetros de oxígeno 20 minutos antes. La punción arterial (radial o femoral) puede ser ligeramente dolorosa. Presión directa post-punción durante 5 minutos.</p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Gasometría Arterial en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Gasometría Arterial es de <strong>$450 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Gasometría Arterial?</h3>
          ...
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-bold text-lg leading-tight">Gasometría Arterial</p>
              </div>
            </div>

            <div className="text-center bg-white/10 rounded-xl py-4 mb-5">
              <p className="text-green-200 text-xs mb-1">Precio Tizayuca</p>
              <p className="text-4xl font-extrabold">$450</p>
              <p className="text-green-300 text-xs">MXN — IVA incluido</p>
            </div>

            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20Gasometr%C3%ADa%20Arterial%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
