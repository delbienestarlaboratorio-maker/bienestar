...
export const metadata: Metadata = {
  title: 'Precio de TSH (Hormona Estimulante de Tiroides) en Tizayuca | Laboratorio Del Bienestar',
  description: 'TSH (Hormona Estimulante de Tiroides) en Tizayuca desde $280 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/tiroides-tsh-tizayuca' },
  openGraph: {
    title: 'Precio de TSH (Hormona Estimulante de Tiroides) en Tizayuca | Laboratorio Del Bienestar',
    description: 'TSH (Hormona Estimulante de Tiroides) en Tizayuca desde $280 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/tiroides-tsh-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">TSH (Hormona Estimulante de Tiroides)</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de TSH (Hormona Estimulante de Tiroides)<br />
            <span className="text-green-300">en Tizayuca, Hidalgo</span>
          </h1>

          <p className="text-green-100 text-lg max-w-2xl mb-8">
            La TSH es producida por la hipófisis y regula la función tiroidea. Es el indicador más sensible de disfunción tiroidea. Valores normales: 0.4-4.0 mUI/L. Elevada indica hipotiroidismo; baja indica hipertiroidismo.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur rounded-2xl px-8 py-5 text-center border border-white/20">
              ...
              <p className="text-5xl font-extrabold text-white">$280</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito TSH (Hormona Estimulante de Tiroides)?</h2>
            <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Sospecha de hipotiroidismo o hipertiroidismo</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Fatiga crónica inexplicable</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Aumento o pérdida de peso sin causa</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Control de tratamiento tiroideo</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Tamizaje en mujeres mayores de 35 años</span>
                </li>
            </ul>
          </section>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">No requiere ayuno. Si toma levotiroxina, tomar la muestra ANTES de la dosis del día. Mejor en ayunas matutinas para mayor consistencia.</p>
          </section>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-green-50 border-2 border-green-500 rounded-xl">
                ...
                <div className="text-right shrink-0 ml-4">
                  <p className="text-3xl font-bold text-green-700">$280</p>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta TSH (Hormona Estimulante de Tiroides) en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de TSH (Hormona Estimulante de Tiroides) es de <strong>$280 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para TSH (Hormona Estimulante de Tiroides)?</h3>
          ...
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-bold text-lg leading-tight">TSH (Hormona Estimulante de Tiroides)</p>
              </div>
            </div>

            <div className="text-center bg-white/10 rounded-xl py-4 mb-5">
              <p className="text-green-200 text-xs mb-1">Precio Tizayuca</p>
              <p className="text-4xl font-extrabold">$280</p>
              <p className="text-green-300 text-xs">MXN — IVA incluido</p>
            </div>

            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20TSH%20(Hormona%20Estimulante%20de%20Tiroides)%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
