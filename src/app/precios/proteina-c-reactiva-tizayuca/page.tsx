...
export const metadata: Metadata = {
  title: 'Precio de Proteína C Reactiva (PCR) Cuantitativa en Tizayuca | Laboratorio Del Bienestar',
  description: 'Proteína C Reactiva (PCR) Cuantitativa en Tizayuca desde $180 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/proteina-c-reactiva-tizayuca' },
  openGraph: {
    title: 'Precio de Proteína C Reactiva (PCR) Cuantitativa en Tizayuca | Laboratorio Del Bienestar',
    description: 'Proteína C Reactiva (PCR) Cuantitativa en Tizayuca desde $180 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/proteina-c-reactiva-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Proteína C Reactiva (PCR) Cuantitativa</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Proteína C Reactiva (PCR) Cuantitativa<br />
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito Proteína C Reactiva (PCR) Cuantitativa?</h2>
            <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Infección bacteriana vs viral</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Monitoreo de tratamiento antibiótico</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Evaluación de inflamación crónica</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Riesgo cardiovascular (PCR ultrasensible)</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Post-cirugía o trauma</span>
                </li>
            </ul>
          </section>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">No requiere ayuno especial. Informar sobre enfermedades activas o medicamentos antiinflamatorios actuales.</p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Proteína C Reactiva (PCR) Cuantitativa en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Proteína C Reactiva (PCR) Cuantitativa es de <strong>$180 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Proteína C Reactiva (PCR) Cuantitativa?</h3>
          ...
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-bold text-lg leading-tight">Proteína C Reactiva (PCR) Cuantitativa</p>
              </div>
            </div>
            ...
            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20Prote%C3%ADna%20C%20Reactiva%20(PCR)%20Cuantitativa%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
