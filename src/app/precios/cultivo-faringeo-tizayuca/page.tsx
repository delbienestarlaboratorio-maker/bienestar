...
export const metadata: Metadata = {
  title: 'Precio de Cultivo Faríngeo con Antibiograma en Tizayuca | Laboratorio Del Bienestar',
  description: 'Cultivo Faríngeo con Antibiograma en Tizayuca desde $350 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/cultivo-faringeo-tizayuca' },
  openGraph: {
    title: 'Precio de Cultivo Faríngeo con Antibiograma en Tizayuca | Laboratorio Del Bienestar',
    description: 'Cultivo Faríngeo con Antibiograma en Tizayuca desde $350 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/cultivo-faringeo-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Cultivo Faríngeo con Antibiograma</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Cultivo Faríngeo con Antibiograma<br />
            <span className="text-green-300">en Tizayuca, Hidalgo</span>
          </h1>

          <p className="text-green-100 text-lg max-w-2xl mb-8">
            Cultivo microbiológico de muestra faríngea para identificar Streptococcus pyogenes u otros patógenos, con sensibilidad a antibióticos. Fundamental para distinguir faringitis viral de bacteriana y evitar el uso innecesario de antibióticos.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur rounded-2xl px-8 py-5 text-center border border-white/20">
              ...
              <p className="text-5xl font-extrabold text-white">$350</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito Cultivo Faríngeo con Antibiograma?</h2>
            <ul className="space-y-3">
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Amigdalitis bacteriana recurrente</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Faringitis con exudado</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Fiebre y dolor de garganta</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Contacto con caso de faringitis estreptocócica</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Control post-antibiótico</span>
                </li>
            </ul>
          </section>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">No comer, beber ni usar enjuague bucal 2 horas antes. El hisopado se toma de las amígdalas y faringe posterior. Resultado en 48-72 horas.</p>
          </section>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-green-50 border-2 border-green-500 rounded-xl">
                ...
                <div className="text-right shrink-0 ml-4">
                  <p className="text-3xl font-bold text-green-700">$350</p>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Cultivo Faríngeo con Antibiograma en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Cultivo Faríngeo con Antibiograma es de <strong>$350 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Cultivo Faríngeo con Antibiograma?</h3>
        ...
        <aside className="space-y-5">
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-sm text-green-200">Microbiología</p>
                <p className="font-bold text-lg leading-tight">Cultivo Faríngeo con Antibiograma</p>
              </div>
            </div>
            ...
            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20Cultivo%20Far%C3%ADngeo%20con%20Antibiograma%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
