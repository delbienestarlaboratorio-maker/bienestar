...
export const metadata: Metadata = {
  title: 'Precio de Química Sanguínea 6 Elementos en Tizayuca | Laboratorio Del Bienestar',
  description: 'Química Sanguínea 6 Elementos en Tizayuca desde $180 MXN. Sin cita previa. Resultados en 24-48 hrs. 2 sucursales en Tizayuca, Hidalgo. Laboratorio Del Bienestar.',
  alternates: { canonical: 'https://laboratorio.delbienestar.com.mx/precios/quimica-sanguinea-tizayuca' },
  openGraph: {
    title: 'Precio de Química Sanguínea 6 Elementos en Tizayuca | Laboratorio Del Bienestar',
    description: 'Química Sanguínea 6 Elementos en Tizayuca desde $180 MXN. Sin cita previa. Resultados en 24-48 hrs.',
    url: 'https://laboratorio.delbienestar.com.mx/precios/quimica-sanguinea-tizayuca',
  }
};
      ...
      <section className="bg-gradient-to-br from-green-900 to-green-700 text-white py-14">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center gap-1.5 text-green-300 text-sm mb-5 flex-wrap">
            ...
            <ChevronRight size={14} />
            <span className="text-white">Química Sanguínea 6 Elementos</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
            Precio de Química Sanguínea 6 Elementos<br />
            <span className="text-green-300">en Tizayuca, Hidalgo</span>
          </h1>

          <p className="text-green-100 text-lg max-w-2xl mb-8">
            Panel bioquímico que incluye glucosa, urea, creatinina, ácido úrico, colesterol y triglicéridos. Evalúa el funcionamiento hepático, renal y metabólico en un solo estudio.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Cuándo necesito Química Sanguínea 6 Elementos?</h2>
            <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Evaluación renal y hepática</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Chequeo médico anual</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
                  <span>Control de enfermedades metabólicas</span>
                </li>
                <li className="flex items-start gap-2 text-gray-700">
                  <span className="text-green-600 mt-1 text-lg">✓</span>
          ...
          <section className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <p className="text-amber-800 leading-relaxed">Ayuno mínimo de 8 horas. Solo agua natural permitida durante el ayuno.</p>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Cuánto cuesta Química Sanguínea 6 Elementos en Tizayuca?</h3>
                <p className="text-gray-600 text-sm">En Laboratorio Del Bienestar, el precio de Química Sanguínea 6 Elementos es de <strong>$180 MXN</strong>. El precio incluye la toma de muestra, procesamiento en laboratorio certificado y entrega de resultados digitales en 24-48 horas.</p>
              </div>
              <div className="border-b border-gray-100 pb-4">
                <h3 className="font-bold text-gray-800 mb-1">¿Se necesita cita para Química Sanguínea 6 Elementos?</h3>
          ...
          <div className="bg-green-900 text-white rounded-2xl p-6 shadow-xl sticky top-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="font-bold text-lg leading-tight">Química Sanguínea 6 Elementos</p>
              </div>
            </div>
            ...
            <a
              href={`https://wa.me/527716854026?text=Hola,%20quiero%20realizarme%20Qu%C3%ADmica%20Sangu%C3%ADnea%206%20Elementos%20en%20Tizayuca.%20¿Me%20pueden%20dar%20informacion?`}
              target="_blank"
