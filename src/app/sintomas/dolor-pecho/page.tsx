...
export const metadata: Metadata = {
    title: "Dolor en el Pecho (Angina) - Causas, Síntomas y Riesgos Clínicos",
    description: "Conoce todo sobre el origen, las señales de alarma roja, opciones médicas y tratamientos para dolor en el pecho (angina). Clínica Mayo Virtual.",
    openGraph: {
        title: "Guía Médica: Dolor en el Pecho (Angina)",
        description: "Todo lo que necesitas saber antes de ir de urgencias sobre dolor en el pecho (angina)."
    },
    alternates: {
        canonical: 'https://laboratorio.delbienestar.com.mx/sintomas/dolor-pecho',
    },
};
            ...
            <div className="bg-gradient-to-r from-blue-900 to-indigo-900 text-white pt-24 pb-16">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <nav className="flex items-center text-sm text-blue-200 mb-6" aria-label="Breadcrumb">
                        ...
                        <ChevronRight className="w-4 h-4 mx-2" />
                        <span className="text-white font-medium">Dolor en el Pecho (Angina)</span>
                    </nav>

                    <h1 className="text-4xl lg:text-5xl font-extrabold mb-4 leading-tight">Dolor en el Pecho (Angina)</h1>
                    <p className="text-xl text-blue-100 font-light mb-6">
                        Concepto Clínico: <span className="font-semibold text-white">Investigación Clínica sobre Dolor en el Pecho (Angina) (Diagnóstico Diferencial)</span> (CIE-10 / CIE-11: R00-R99)
                    </p>
                    ...
                    <div className="p-8 lg:p-12">
                        ...
                        <section className="mb-12">
                            <div className="bg-rose-50 border-2 border-rose-200 rounded-3xl p-8 shadow-inner">
                                ...
                                <p className="text-rose-800 font-medium mb-4">No ignore las señales del cuerpo. Solicite asistencia médica inmediata o diríjase al hospital más cercano si experimenta dolor en el pecho (angina) acompañado de cualquiera de las siguientes banderas rojas:</p>
