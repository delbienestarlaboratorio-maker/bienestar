...
const batchFiles = ['symptoms-batch-16.json', 'symptoms-batch-17.json', 'symptoms-batch-18.json'];
let added = 0;
...
console.log(`✅ Base de datos actualizada: ${db.length} padecimientos enciclopédicos totales (Se agregaron ${added} nuevos de los bloques 16, 17 y 18).`);
