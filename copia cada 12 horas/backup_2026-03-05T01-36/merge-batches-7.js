...
const batchFiles = ['symptoms-batch-19.json', 'symptoms-batch-20.json'];
let added = 0;
...
console.log(`✅ Base de datos actualizada: ${db.length} padecimientos enciclopédicos totales (Se agregaron ${added} nuevos de los bloques 19 y 20).`);
