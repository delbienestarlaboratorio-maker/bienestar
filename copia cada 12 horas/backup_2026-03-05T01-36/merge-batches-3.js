...
const batchFiles = ['symptoms-batch-7.json', 'symptoms-batch-8.json', 'symptoms-batch-9.json'];
let added = 0;
...
console.log(`✅ Base de datos actualizada: ${db.length} padecimientos totales (Se agregaron ${added} nuevos de los lotes 7, 8 y 9).`);
