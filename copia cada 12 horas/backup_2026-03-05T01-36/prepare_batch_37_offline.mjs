...
const BATCH_SIZE = 50;
const OUTPUT_FILE = 'prompt_batch_37.txt';
...
console.log(`Total processed studies found: ${processedIds.size}`);
...
console.log(`Selected ${batch.length} studies for Batch 37.`);
...
console.log('Use this file to generate the content with your AI model.');
