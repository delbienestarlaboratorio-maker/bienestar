...
const batchFiles = [
    'symptoms-batch-23.json',
    'symptoms-batch-24.json'
];

function mergeBatches() {
    console.log("=== INICIANDO INTEGRACIÓN DE LOTES 23 Y 24 ===");
    let masterData = [];
    ...
    if (addedCount > 0) {
        try {
            ...
            console.log(`[STATUS] Total histórico en \`symptoms-massive.json\`: ${masterData.length} padecimientos listos para SSG.`);
        } catch (err) {
